...
Backend-разработчик с опытом командной разработки и построения архитектуры API-сервисов для IoT и рекламных платформ. Специализируюсь на Kotlin и Ktor, умею быстро адаптироваться к новым требованиям и фокусируюсь на масштабируемости и автоматизации процессов.
...
- **API и интеграции:** OpenAPI (Swagger), Telegram Bot API, OpenAI API, Yandex LLM API, Mistral AI API, Bybit API
